...
START_TRACEOUT_AT_INSTRUCTION_NO = 369242709  # 39510000 # 39691180
EXIT_EMULATOR_AT_INSTRUCTION_NO = 369242809  # 24000000
BREAKPOINT_AT_INSTRUCTION_NO = None  # 3703404


# Generate CPU state output for all instructions
if 0:
    START_TRACEOUT_AT_INSTRUCTION_NO = 0  #31000000
    EXIT_EMULATOR_AT_INSTRUCTION_NO  = 45000000
