...
START_TRACEOUT_AT_INSTRUCTION_NO = 37327580  # 3376956
EXIT_EMULATOR_AT_INSTRUCTION_NO  = 37327600  # 3376958
...
# TEMP
if 1:
    START_TRACEOUT_AT_INSTRUCTION_NO = 3376954
    EXIT_EMULATOR_AT_INSTRUCTION_NO  = 3379330
    # LOGGER_REPORT_TYPE = ReportType.C_EMU_REPORT
    # BREAKPOINT_AT_INSTRUCTION_NO = 3376955
    TTY_OUTPUT_ENABLED = True
